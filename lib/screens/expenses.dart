                          ...
                          if (message.sender?.indexOf('BOBTXN') != -1) {
                            for (int j = 3; j < 15; j++) {
                              ...
                              if (isNumeric(message.body.toString()[j])) {
                                if (pp) {
                                  rek = rek * 10 +
                                      double.parse(message.body.toString()[j]);
                                } else {
                                  dd = dd + 1;
                                  double temp =
                                      double.parse(message.body.toString()[j]);
                            ...
                            if (message.body.toString().indexOf('credited') !=
                                -1) {
                              for (int j =
                                      message.body.toString().indexOf('Rs') + 2;
                            ...
                            if (message.body.toString().indexOf('Credited') !=
                                -1) {
                              for (int j =
                                      message.body.toString().indexOf('Rs') + 3;
                                  j < message.body.toString().length;
                                  j++) {
                                if (isNumeric(message.body.toString()[j])) {
                                  if (pp) {
                    ...
                    trialvms().then((value) {
                      for (int i = 0; i < _messages.length; i++) {
                        ...
                        if (_messages[i].date?.year == DateTime.now().year) {
                          ...
                          } else if (message.sender?.indexOf('ICICIB') != -1) {
